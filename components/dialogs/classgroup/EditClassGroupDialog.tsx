...
export function EditClassGroupDialog({ children, turmaId, defaultValues, onUpdated }: Props) {
  ...
  const onSubmit = async (data: z.infer<typeof CreateClassGroupSchema>) => {
    try {
      ...
      ErrorToast(error.response?.data?.message || "Erro ao atualizar turma.");
    } finally {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => form.setValue("isEvent", !!checked)}
            />
