...
export function ClassGroupDialog({ children, onCreated }: Props) {
  ...
  const onSubmit = async (data: z.infer<typeof CreateClassGroupSchema>) => {
    try {
      ...
      form.reset();
      onCreated?.();
      SuccessToast("Turma criada com sucesso!");
    } catch (error) {
      console.error("Erro ao criar turma:", error);
      ErrorToast(error.response?.data?.message || "Erro ao criar turma. Tente novamente.");
    } finally {
      ...
      <DialogContent>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <div className="flex-1">
              <Label htmlFor="endDate" className="text-foreground">Data Término*</Label>
              <Input 
                type="date" 
                id="endDate" 
