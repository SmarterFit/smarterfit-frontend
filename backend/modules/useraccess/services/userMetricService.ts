...
import { MetricDataRequestDTO } from "../schemas/userMetricSchemas";
...
export const userMetricService = {
    ...
    */
   async getByTypeId(metricTypeId: string): Promise<MetricDataResponseDTO[]> {
   ...
   /**
    * Pegar a última métricas de todos os tipos
    */
   async getLasts(): Promise<MetricDataResponseDTO[]> {
      return await apiRequest<MetricDataResponseDTO[]>({
         method: "get",
         path: `/metrica/listar/ultimos`,
      });
   },
